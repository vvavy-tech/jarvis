...
async def _bring_page_window_to_front(
    page: Page,
) -> None:
...
class BrowserManager:
    ...
    async def click(
        ...
        async with self._lock:
            locator = await self._resolve_target(
                page,
                target,
            )
    ...
    async def type_text(
        ...
        async with self._lock:
            locator = await self._resolve_textbox(
                page,
                target,
            )
